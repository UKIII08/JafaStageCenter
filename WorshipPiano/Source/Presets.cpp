...
const std::vector<Preset>& factory()
{
    static const std::vector<Preset> list =
    {
        ...
        { "Sunday Grand", "Classic",
          ...
          { { pid::reverbMachine, 1 }, { pid::model, 0 }, { pid::tone, 0.0f }, { pid::attack, 0.30f },
        ...
        { "Intimate Prayer", "Classic",
          ...
          { { pid::reverbMachine, 0 }, { pid::model, 0 }, { pid::tone, -0.35f }, { pid::attack, 0.22f },
        ...
        { "Ballad Grand", "Classic",
          ...
          { { pid::reverbMachine, 1 }, { pid::model, 0 }, { pid::tone, 0.12f }, { pid::attack, 0.32f },
        ...
        { "Upright Chapel", "Classic",
          ...
          { { pid::reverbMachine, 0 }, { pid::model, 2 }, { pid::tone, 0.0f }, { pid::attack, 0.45f },
        ...
        { "Modern Worship Lead", "Modern",
          ...
          { { pid::reverbMachine, 2 }, { pid::model, 1 }, { pid::tone, 0.25f }, { pid::attack, 0.42f },
        ...
        { "Arena Anthem", "Modern",
          ...
          { { pid::reverbMachine, 2 }, { pid::model, 1 }, { pid::tone, 0.35f }, { pid::attack, 0.50f },
        ...
        { "Pad Underneath", "Modern",
          ...
          { { pid::reverbMachine, 1 }, { pid::model, 0 }, { pid::tone, 0.05f }, { pid::attack, 0.30f },
        ...
        { "Upper Room", "Ambient",
          ...
          { { pid::reverbMachine, 5 }, { pid::model, 3 }, { pid::tone, -0.10f }, { pid::attack, 0.28f },
        ...
        { "Felt & Air", "Ambient",
          ...
          { { pid::reverbMachine, 4 }, { pid::model, 3 }, { pid::tone, -0.30f }, { pid::attack, 0.20f },
        ...
        { "Ambient Bed", "Ambient",
          ...
          { { pid::reverbMachine, 3 }, { pid::model, 3 }, { pid::tone, -0.25f }, { pid::attack, 0.15f },
        ...
        { "Soaking Grand", "Soak",
          ...
          { { pid::reverbMachine, 4 }, { pid::model, 0 }, { pid::tone, -0.05f },
        ...
        { "Soaking Cloud", "Soak",
          ...
          { { pid::reverbMachine, 3 }, { pid::model, 3 }, { pid::tone, -0.15f },
        ...
        { "Prayer Room", "Soak",
          ...
          { { pid::reverbMachine, 4 }, { pid::model, 3 }, { pid::tone, -0.20f },
        ...
        { "Infinite Wash", "Soak",
          ...
          { { pid::reverbMachine, 5 }, { pid::model, 3 }, { pid::tone, -0.10f },
        ...
        { "Stage Clean", "Live",
          ...
          { { pid::reverbMachine, 0 }, { pid::model, 1 }, { pid::tone, 0.15f }, { pid::attack, 0.40f },
